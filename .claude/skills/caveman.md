...
unsure. Off only: "stop caveman" / "normal mode".
...
- full: "Pool reuse open DB connections. No new connection per request. Skip handshake
  overhead."
...
sequences where fragment order risks misread, user asks to clarify or repeats question.
...
Code/commits/PRs: write normal. "stop caveman" or "normal mode": revert. Level persist
